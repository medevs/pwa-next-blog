import me from 'public/static/avatar.png';

export const avatar = me;
export const name = 'Primal Bound';

export const about = () => {
  return (
    <>
      <b>Primal Bound</b>, a movement dedicated to empowering young people and sharing knowledge on the topics that truly matter. It's not just a blog; it's a transformative journey towards unlocking our full potential. 
    </>
  );
};
